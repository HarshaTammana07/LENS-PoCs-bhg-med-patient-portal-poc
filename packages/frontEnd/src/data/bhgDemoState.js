  ...
  'MSG-301': [
    ...
    { id: 'r-301-3', sender: 'Alicia Monroe', time: 'Today · 8:12 AM', text: 'That’s great progress. I’m looking forward to seeing you Thursday at 10:30 AM — we can build on what’s working and adjust anything that feels hard.' },
    {
      ...
      voiceNote: {
        duration: '0:24',
        durationSeconds: 24,
        transcript: 'Hi Jordan, I also recorded a quick voice check-in for you. Staying on track with your morning routine is a major milestone in your recovery plan. Bring any questions about your take-home schedule on Thursday and we will go over them together in Room 4!',
        audioWave: [24, 42, 65, 85, 55, 38, 72, 95, 88, 48, 62, 85, 92, 68, 42, 58, 76, 52, 38, 25],
      },
    },
  ],
  'MSG-298': [
    ...
    clinicianMessages: [
      {
        ...
        preview: '🎤 Voice note (0:19) from Kendall',
        time: 'Today · 9:18 AM',
        unreadCount: 2,
        thread: [
          ...
          {
            id: 'cm-501-3',
            sender: 'Kendall Wright',
            time: 'Today · 9:18 AM',
            text: '🎤 Voice note (0:19)',
            voiceNote: {
              duration: '0:19',
              durationSeconds: 19,
              transcript: "Hi Morgan, leaving a voice note because it's easier while I'm walking to work. My car is in the shop until Friday, so I won't have a ride to tomorrow's dosing window unless there's clinic transit support.",
              audioWave: [30, 50, 75, 85, 65, 45, 80, 90, 75, 55, 60, 80, 70, 50, 40, 65, 75, 60, 35, 20],
            },
          },
        ],
      },
      {
        ...
        unreadCount: 1,
        thread: [
          { id: 'cm-502-1', sender: 'Morgan Reed', time: 'Sep 12 · 4:10 PM', text: 'Hi Jordan, your last screening looked stable. I’d like to review your recovery goals and weekly routine at our Thursday visit.' },
          { id: 'cm-502-2', sender: 'Jordan Williams', time: 'Sep 13 · 9:05 AM', text: 'Thank you. I’ve been keeping up with the morning routine we discussed.' },
          { id: 'cm-502-3', sender: 'Morgan Reed', time: 'Today · 8:12 AM', text: 'That’s great progress. I’m looking forward to seeing you Thursday at 10:30 AM — we can build on what’s working and adjust anything that feels hard.' },
          {
            id: 'cm-502-4',
            sender: 'Morgan Reed',
            time: 'Today · 8:15 AM',
